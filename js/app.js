    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ymaps.ready((function() {
                ...
                let myPlacemark = new ymaps.Placemark([ 55.796127, 49.106414 ], {}, {});
                myMap.geoObjects.add(myPlacemark);
            }));
            ymaps.ready((function() {
                let myMap = new ymaps.Map("locator", {
                    controls: [],
                    center: [ 55.796127, 49.106414 ],
                    zoom: 14
                });
        ...
        document.querySelectorAll(".filter__dropdown-toggle").forEach(dropDownFunc);
        function dropDownFunc(dropDown) {
            if (true === dropDown.classList.contains("js-toggle")) dropDown.addEventListener("click", (function(e) {
                e.preventDefault();
                if (true === this.nextElementSibling.classList.contains("active")) {
        ...
        window.addEventListener("click", (function(e) {
            if (null === e.target.closest(".filter__dropdown")) closeDropdown();
        }));
        function closeDropdown() {
            document.querySelectorAll(".filter__dropdown").forEach((function(container) {
                container.classList.remove("open");
            }));
            document.querySelectorAll(".filter__dropdown-content").forEach((function(menu) {
